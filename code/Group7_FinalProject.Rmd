...
```{r load libraries and fonts, warning = FALSE, message = FALSE, include = FALSE}
library(tidyverse)
library(readxl)
library(vroom)
library(ggtext)
...
```{r baltic dirty tanker, warning = FALSE, message = FALSE, fig.width = 40, fig.height = 20}
...
```{r global_crude_import, warning = FALSE, message = FALSE, fig.width = 40, fig.height = 20}
